<section class="hero-band">
    <div class="container">
        ...
        <div class="category-grid">
            <?php
            $gallery = [
                ['src' => '/assets/images/institute/maps-campus-building.jpg', 'alt' => 'Aura Medical Institute campus building, Coimbatore', 'cap' => 'Campus Building'],
                ['src' => '/assets/images/institute/maps-hospital-front.jpg', 'alt' => 'Aura Institutions and Hospital front view', 'cap' => 'Hospital Front'],
                ['src' => '/assets/images/institute/maps-hospital-interior.jpg', 'alt' => 'Aura Hospital interior facilities', 'cap' => 'Hospital Interior'],
