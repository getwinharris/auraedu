...
<form method="post" action="/admin/blog/save" id="blog-form" class="admin-blog-editor" hidden>
    ...
    <div class="admin-blog-editor__grid">
        ...
        <label class="admin-blog-editor__wide">SEO Keywords <input type="text" name="keywords" id="edit-keywords" placeholder="electropathy, medical education, acupuncture" style="width:100%"><small>Comma-separated keywords for search engine indexing.</small></label>
