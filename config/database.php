...
$appUrl = rtrim((string)($env['APP_URL'] ?? $_SERVER['APP_URL'] ?? $_ENV['APP_URL'] ?? 'https://auraedu.co.in'), '/');
return [
    'host' => $env['BAPX_MYSQL_HOST'] ?: 'localhost',
    'port' => $env['BAPX_MYSQL_PORT'] ?: '3306',
    'dbname' => $env['BAPX_MYSQL_DB'] ?: 'u907253411_db_name_aura',
    'user' => $env['BAPX_MYSQL_USER'] ?: 'u907253411_db_user_aura',
