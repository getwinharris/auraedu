...
final class ProjectMapService {
    ...
    public static function registry(): array {
        $routes = [
            ...
            ['method'=>'GET','path'=>'/api/hospitals','name'=>'api.hospitals','page'=>'public/404','controller'=>'ApiController@hospitals','services'=>['TempleService']],
    ...
    private static function routeDesc(string $path, string $method = 'GET'): string {
        ...
        $descs = [
            ...
            '/hospitals'         => 'Hospital & campus facility listing',
            '/hospitals/{slug}'  => 'Hospital & campus facility detail',
            ...
            '/admin/temples'    => 'Admin — manage hospital facilities',
            ...
            '/admin/temples/save|POST' => 'Admin — create/update hospital facility',
            '/admin/temples/delete|POST' => 'Admin — delete hospital facility',
